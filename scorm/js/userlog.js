function StartLog(id_utente,id_contenuto,supporto,uniqid){
    ...
    //jQuery.when(jQuery.get("/www.carigelearning.it/home/index.php?option=com_gglms&id_utente="+id_utente+"&id_contenuto="+id_contenuto+"&supporto="+supporto+"&uniqid="+uniqid+"&task=report.insertUserLog"))
        .done(function(data){
...
function EndLog(uniqid) {
    ...
    //jQuery.when(jQuery.get("/www.carigelearning.it/home/index.php?option=com_gglms&uniqid="+uniqid+"&task=report.updateUserLog"))
        .done(function(data){
            // data=JSON.parse(data);
        });
