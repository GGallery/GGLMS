...
class gglmsViewusercontents extends JViewLegacy {
...
//      $this->sortDirection = $this->state->get('list.direction');
    ...
    protected function addToolBar() {
        ...
        //JToolBarHelper::title(JText::_('COM_GGLMS_MANAGER_LOGS'), 'logs');
        JToolBarHelper::title("LOGS: DETTAGLIO CONTENUTI NEL CORSO");
    }
