...
function browser_detection( $which_test, $test_excludes='', $external_ua_string='' ) 
{
	...
	*/
	if ( !$b_repeat ) {
		...
		*/
		$a_webkit_types = array( 'arora', 'bolt', 'beamrise', 'chromium', 'chrome', 'crios', 'dooble', 'epiphany', 'gtklauncher', 'icab', 'konqueror', 'maxthon',  'midori', 'omniweb', 'opera', 'qupzilla', 'rekonq', 'rocketmelt', 'safari', 'shiira', 'sputnik', 'steel', 'teashark', 'uzbl', 'applewebkit', 'webos', 'xxxterm', 'webkit' );
