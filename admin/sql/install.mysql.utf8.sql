...
-- ----------------------------
-- Table structure for `#__gg_votazioni_candidati`
-- ----------------------------
...
CREATE TABLE IF NOT EXISTS `#__gg_votazioni_candidati` (
      ...
      `tipo_votazione` varchar(100) NOT NULL COMMENT '1: presidente, 2: consiglieri, NULL: scheda bianca',
      `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
      PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `#__gg_votazioni_lista_candidati`
-- ----------------------------
...
INSERT INTO `#__comprofiler_field_values` (`fieldid`, `fieldtitle`, `fieldlabel`, `fieldgroup`, `ordering`, `sys`) VALUES
	...
	(70, 'Biologo/Medicina del lavoro', '', 0, 0, 0),
	...
	(70, 'Chimico/Chimica analitica', '', 0, 0, 0),
	...
	(70, 'Farmacista/Biochimica clinica', '', 0, 0, 0),
	(70, 'Farmacista/Farmacia ospedaliera', '', 0, 0, 0),
	(70, 'Farmacista/Farmacia territoriale', '', 0, 0, 0),
	(70, 'Fisico/Fisica Sanitaria', '', 0, 0, 0),
	...
	(70, 'Medico chirurgo/Medicina generale', '', 0, 0, 0),
	...
	(70, 'Medico chirurgo/Medicine alternative', '', 0, 0, 0),
	...
	(70, 'Medico chirurgo/Patologia clinica', '', 0, 0, 0),
	(70, 'Medico chirurgo/Pediatria', '', 0, 0, 0),
	...
	(70, 'Odontoiatra/Chirurgia odontostomatologica', '', 0, 0, 0),
	(70, 'Odontoiatra/Odontoiatria e protesi dentaria', '', 0, 0, 0),
	(70, 'Odontoiatra/Odontostomatologia', '', 0, 0, 0),
	(70, 'Odontoiatra/Ortognatodonzia', '', 0, 0, 0),
	(70, 'Odontotecnico', '', 0, 0, 0),
