...
ALTER TABLE `#__comprofiler`
	ADD COLUMN IF NOT EXISTS `cb_cognome` text,
	ADD COLUMN IF NOT EXISTS `cb_codicefiscale` text,
	ADD COLUMN IF NOT EXISTS `cb_datadinascita` date DEFAULT NULL,
	ADD COLUMN IF NOT EXISTS `cb_luogodinascita` text,
	ADD COLUMN IF NOT EXISTS `cb_provinciadinascita` text,
	ADD COLUMN IF NOT EXISTS `cb_indirizzodiresidenza` text,
	ADD COLUMN IF NOT EXISTS `cb_provdiresidenza` text,
	ADD COLUMN IF NOT EXISTS `cb_cap` text,
	ADD COLUMN IF NOT EXISTS `cb_telefono` text,
	ADD COLUMN IF NOT EXISTS `cb_nome` text,
	ADD COLUMN IF NOT EXISTS `cb_citta` text,
	ADD COLUMN IF NOT EXISTS `cb_professionedisciplina` text,
	ADD COLUMN IF NOT EXISTS `cb_ordine` text,
	ADD COLUMN IF NOT EXISTS `cb_numeroiscrizione` text,
	ADD COLUMN IF NOT EXISTS `cb_reclutamento` text,
	ADD COLUMN IF NOT EXISTS `cb_ateco` text,
	ADD COLUMN IF NOT EXISTS `cb_codicereclutamento` text,
	ADD COLUMN IF NOT EXISTS `cb_professione` text,
	ADD COLUMN IF NOT EXISTS `cb_profiloprofessionale` text,
	ADD COLUMN IF NOT EXISTS `cb_settore` text,
	ADD COLUMN IF NOT EXISTS `cb_societa` text,
	ADD COLUMN IF NOT EXISTS `cb_rischio` text,
	ADD COLUMN IF NOT EXISTS `cb_privacy` tinyint(3),
	ADD COLUMN IF NOT EXISTS `cb_regione` text,
	ADD COLUMN IF NOT EXISTS `cb_dataiscrizione` text,
	ADD COLUMN IF NOT EXISTS `cb_azienda` text,
	ADD COLUMN IF NOT EXISTS `cb_dipartimento` text,
	ADD COLUMN IF NOT EXISTS `cb_reparto` text,
	ADD COLUMN IF NOT EXISTS `cb_laureain` text,
	ADD COLUMN IF NOT EXISTS `cb_laureanno` text,
	ADD COLUMN IF NOT EXISTS `cb_qualifica` text,
	ADD COLUMN IF NOT EXISTS `cb_newsletter` tinyint(3),
	ADD COLUMN IF NOT EXISTS `cb_ultimoannoinregola` text,
	ADD COLUMN IF NOT EXISTS `cb_accessonutritiononline` tinyint(3),
	ADD COLUMN IF NOT EXISTS `cb_codicenutritiononline` text,
	ADD COLUMN IF NOT EXISTS `cb_titolo` text,
	ADD COLUMN IF NOT EXISTS `cb_altraemail` text;
