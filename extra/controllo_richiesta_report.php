...
class controlloRichiestaReport extends JApplicationCli
{
    ...
    public function doExecute()
    {
        ...
        try {
            ...
            $controllo_richiesta_report = $api->controllo_richiesta_report($host_string,
                $db_user,
                $db_password,
                $db_database,
                $db_prefix,
            ...
            $this->out('Script ended with ' . $controllo_richiesta_report . ' at:' . date('H:i:s') . ' on ' . date('d/m/Y'));
        } catch (Exception $e) {
...
JApplicationCli::getInstance('controlloRichiestaReport')->execute();
