...
class importUsers extends JApplicationCli {
    ...
    public function doExecute() {
        ...
        try {
            ...
            $users = new gglmsControllerUsers();
            $import = $users->_import();

            $this->out('Script ended with ' . $import . ' at:' . date('H:i:s') . ' on ' . date('d/m/Y'));
        }
        catch (Exception $e) {
...
JApplicationCli::getInstance('importUsers')->execute();
