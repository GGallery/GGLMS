...
class reportMensile extends JApplicationCli {
    ...
    public function doExecute() {
        ...
        try {
            ...
            $report_mensile = $api->get_report_per_box($mese, $anno);

            $this->out('Script ended with ' . $report_mensile . ' at:' . date('H:i:s') . ' on ' . date('d/m/Y'));
        }
        catch (Exception $e) {
...
JApplicationCli::getInstance('reportMensile')->execute();
