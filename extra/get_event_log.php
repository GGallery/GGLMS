...
class getEventLog extends JApplicationCli {
    ...
    public function doExecute() {
        ...
        try {
            ...
            $get_event_log = $api->get_event_log();

            $this->out('Script ended with ' . $get_event_log . ' at:' . date('H:i:s') . ' on ' . date('d/m/Y'));
        }
        catch (Exception $e) {
...
JApplicationCli::getInstance('getEventLog')->execute();
