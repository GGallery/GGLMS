...
class importAnagraficaFarmacia extends JApplicationCli {
    ...
    public function doExecute() {
        ...
        try {
            ...
            $importa_anagrafica_farmacie = $api->importa_anagrafica_farmacie($is_debug);
...
JApplicationCli::getInstance('importAnagraficaFarmacia')->execute();
