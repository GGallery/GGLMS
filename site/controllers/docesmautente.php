 ...
 * @since  1.5.19
 */
class gglmsControllerDocesmaUtente extends JControllerLegacy
{
    protected $_db;
    private $_app;
    private $params;
...
//        $this->params = $this->_app->getParams();
    ...
    public function get_user_name(){
        ...
        try {
            ...
            $model=$this->getModel('docesmautente');
    ...
    public function get_docs(){
        ...
        try {
            ...
            $attestati=array_diff(scandir($_SERVER['DOCUMENT_ROOT'].'/mediagg/docesma/'),array('..', '.'));
            ...
            foreach ($attestati as $attestato){
                ...
                if($id_utente==$user_id) {
                    ...
                    $attestato_to_return="<a target=\"_blank\" href=../mediagg/docesma/".$attestato.">".$attestato_to_return_label."</a>";
