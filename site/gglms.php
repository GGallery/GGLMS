...
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR45');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR46');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR47');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR48');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR49');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR50');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR51');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR52');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR53');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR54');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR55');
JText::script('COM_PAYPAL_ACQUISTA_EVENTO_STR56');
...
JText::script('COM_REGISTRAZIONE_ASAND_STR15');
