...
class gglmsViewreportkendo extends JViewLegacy
{
    ...
    function display($tpl = null)
    {
        ...
        JHtml::_('stylesheet', 'components/com_gglms/libraries/css/reportkendo.css');
        JHtml::_('stylesheet', 'components/com_gglms/libraries/css/loader.css');

        JHtml::script(Juri::base() . 'components/com_gglms/libraries/js/reportkendo.js');
