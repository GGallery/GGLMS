...
//            echo "non puoi vedere". $unita->titolo;
            ...
            try {
                ...
                ?>
            <div class="g-block <?php echo $this->unita->_params->get('larghezza_box_unita') ?> <?php echo $unita->get_access_class() ?>">
