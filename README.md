...
# 4.2.5
* D: aggiunta della tabella gg_votazioni_lista_candidati

# 4.2.4
* D: aggiunta della tabella gg_cod_votazioni_users
* D: aggiunta della tabella gg_votazioni_candidati
...
* B: implementata la coppia controller/model syncviewstatouser per la creazione delle viste per il stato di completamento unità e corso da parte dell'utente. E' prevista l'esecuzione tramite task e tramite script
